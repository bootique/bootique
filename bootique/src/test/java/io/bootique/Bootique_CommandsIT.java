...
public class Bootique_CommandsIT {
    ...
    @Test
    public void testStandard_Plus_Module_Commands() {
        BQRuntime runtime = runtimeFactory.app().modules(M0.class, M1.class).createRuntime();

        CommandManager inspector = runtime.getInstance(CommandManager.class);
    ...
    public void testCreateInjector_AppCommands() {
        ...
        // TODO: override/with does not compile as a single chain. Why?
        BQModuleOverrideBuilder<BQInternalTestFactory.Builder> overrideBuilder =
                runtimeFactory.app().modules(M0.class, M1.class).override(BQCoreModule.class);
        BQRuntime runtime = overrideBuilder.with(M_RemoveCommands.class)
                .createRuntime();
