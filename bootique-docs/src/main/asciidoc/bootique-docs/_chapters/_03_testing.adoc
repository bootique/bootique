...
This chapter is about the core test framework. For module-specific test APIs (e.g. `bootique-jdbc-junit`,
`bootique-jetty-junit`), check documentation of those modules. They all follow the same base principles
described here.
...
----
{
  testImplementation: 'io.bootique:bootique-junit'
}
----
====
...
(e.g. `TcDbTester` tool from `bootique-jdbc-junit-testcontainers` starts a test database and supplies a "module" to
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/docs/testing/NetworkTest.java[tag=all]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/docs/testing/BQModuleTest.java[tag=test]
----
