...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/docs/programming/commands/custom/MyCommand.java[tag=command]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/docs/programming/commands/custom/MyModule.java[tag=addCommand]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/docs/programming/commands/custom/MyDaemonCommand.java[tag=run]
----
