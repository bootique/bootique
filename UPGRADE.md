...
"abstract", if you have a JDBC app (i.e. if you import `bootique-jdbc` either directly or via another module like
`bootique-cayenne`, etc.), on startup you will see an error like this:
